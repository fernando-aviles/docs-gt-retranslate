...
<Update label="March 2025">
  ...
  You can now generate an MCP server for your docs, allowing AI tools to:

  1. Query your OpenAPI spec in real-time to execute user requests.

  2. Retrieve your docs without requiring manual context loads.

  Run a CLI command to generate the server.
</Update>
