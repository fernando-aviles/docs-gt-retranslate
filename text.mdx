...
<Tip>
  Use blockquotes sparingly to maintain their visual impact and meaning. Consider using [callouts](/widgets/callouts) for notes, warnings, and other information.
</Tip>
