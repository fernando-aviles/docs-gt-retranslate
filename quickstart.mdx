...
This quickstart guide shows you how to set up and deploy your documentation site in under 10 minutes.
...
**Prerequisites**: 
- [Create a Mintlify account](https://mintlify.com/start) and complete onboarding
- Have a GitHub account for repository integration
