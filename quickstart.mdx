...
<Card title="Add interactive widgets" icon="puzzle" href="/widgets/accordions" horizontal>
  Enhance your documentation with interactive widgets like accordions, tabs, and code samples.
</Card>
