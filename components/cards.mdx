...
<Card title="Card title" icon="text" href="/widgets/columns">
...
<Card title="Link card" icon="link" href="/widgets/columns" arrow="true" cta="Click here">
...
Use the [Columns component](/widgets/columns) to organize multiple cards side by side.
