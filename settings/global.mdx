...
<ResponseField name="feedback" type="Feedback">
  ...
  <Expandable title="Feedback">
    ...
    <ResponseField name="suggestEdit" type="boolean" default={false}>
      Enables a button to allow users to suggest edits via pull requests. This only works with public repos. The edits are suggested on the repo, not in Mintlify.&#x20;
    </ResponseField>

    <ResponseField name="raiseIssue" type="boolean" default={false}>
      Enables a button to allow users to raise an issue about the documentation. This only works with public repos. The issues raised are on the repo, not in Mintlify.&#x20;
    </ResponseField>
  </Expandable>
</ResponseField>
