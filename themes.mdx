...
<ThemeCard title="Linden" value="linden" description="Vintage minimalism meets modern documentation needs." href="https://linden.mintlify.app" />

<ThemeCard title="Sage" value="sage" description="Bold, contemporary design for next-generation SaaS platforms." href="https://sage.mintlify.app" />

<ThemeCard title="Oak" value="oak" description="Structured clarity that puts content organization first." href="https://oak.mintlify.app" />

<ThemeCard title="Chestnut" value="chestnut" description="Content-first design with personality through boxed layouts and structured hierarchy." href="https://chestnut.mintlify.app" />

<ThemeCard title="Kernel" value="kernel" description="Expansive layout optimized for extensive documentation and rich content display." href="https://kernel.mintlify.app" />
